...
- eval_run_id: `1ab46c15-1494-4cd3-8df0-8d55cf417f8d`
- run_type: `golden_dataset`
- status: `completed`
- started_at: `2026-05-08 21:41:03.984637708 UTC`
- completed_at: `2026-05-08 21:42:54.487708268 UTC`
- runtime_run_count: `1`
...
> iter_1 = initial iterations; iter_2 = continuation iterations

| metric | iter_1 | iter_2 | total | formula |
|---|---:|---:|---:|---|
| usable_first_response_rate | 1.0000 | 1.0000 | 1.0000 | frac(FA1≥1 ∧ FA2≥1 ∧ FA5≥1) |
| query_structuring_judge_score | 0.5000 | n/a | 0.2500 | mean over iter_1 of avg(QS1, QS2) |
| evidence_pack_judge_score | 1.5000 | n/a | 0.7500 | mean over iter_1 of avg(EP1, EP2) |
| final_answer_judge_score | 2.0000 | 1.8000 | 1.9000 | mean over runs of avg(FA1, FA2, FA3, FA4, FA5) |
| query_structuring_no_hard_fail_rate | 0.0000 | n/a | 0.5000 | frac(QS1>0 ∧ QS2>0) |
...
| continuation_hypothesis_update_discipline_score | n/a | 2.0000 | 2.0000 | mean(CU1) over iter_2 |
| continuation_problem_understanding_update_score | n/a | 2.0000 | 2.0000 | mean(CU2) over iter_2 |
| continuation_next_check_progression_score | n/a | 2.0000 | 2.0000 | mean(CU3) over iter_2 |
| continuation_observation_resolution_context_recovery_score | n/a | 2.0000 | 2.0000 | mean(CU4) over iter_2 |
| usable_continuation_response_rate | n/a | 1.0000 | 1.0000 | frac(CU1≥1 ∧ CU2≥1 ∧ CU3≥1 ∧ FA1≥1 ∧ FA2≥1 ∧ FA5≥1) |
| continuation_update_judge_score | n/a | 2.0000 | 2.0000 | mean over iter_2 of avg(CU1, CU2, CU3) |
...
| continuation_input_judge_score | n/a | 2.0000 | 2.0000 | mean(CU4) over iter_2 |
...
|---|---:|---:|---:|---:|
| continuation_hypothesis_update_discipline | 1689 | 822 | 2511 | 0.000249 |
| continuation_next_check_progression | 1172 | 386 | 1558 | 0.000136 |
| continuation_observation_resolution_context_recovery | 1059 | 680 | 1739 | 0.000189 |
| continuation_problem_understanding_update | 1389 | 382 | 1771 | 0.000146 |
| evidence_pack_role_fit | 2884 | 913 | 3797 | 0.000327 |
| evidence_pack_sufficiency | 4104 | 722 | 4826 | 0.000350 |
| final_alternative_context_handling | 9736 | 683 | 10419 | 0.000623 |
| final_first_check_discriminates | 9858 | 797 | 10655 | 0.000652 |
| final_hypothesis_source_alignment | 8338 | 1411 | 9749 | 0.000699 |
| final_no_root_cause_claim | 9766 | 688 | 10454 | 0.000626 |
| final_result_interpretation_usefulness | 1775 | 1247 | 3022 | 0.000338 |
| query_structuring_field_boundary_correctness | 713 | 408 | 1121 | 0.000117 |
| query_structuring_grounding_conservatism | 683 | 790 | 1473 | 0.000192 |
...
| judge_total | 53166 | 9929 | 63095 | 0.004644 |
| run_total | 61682 | 14460 | 76142 | 0.005440 |

Run total cost usd = runtime total cost usd + judge total cost usd = 0.000796 + 0.004644 = 0.005440
