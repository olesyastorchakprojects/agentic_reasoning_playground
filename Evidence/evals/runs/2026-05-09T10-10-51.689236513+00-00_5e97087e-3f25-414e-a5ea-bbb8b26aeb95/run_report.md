...
- eval_run_id: `5e97087e-3f25-414e-a5ea-bbb8b26aeb95`
- run_type: `golden_dataset`
- status: `completed`
- started_at: `2026-05-09 10:10:51.689236513 UTC`
- completed_at: `2026-05-09 10:15:12.408051575 UTC`
- runtime_run_count: `1`
...
| gate_pass_rate | 0.5000 | Share of runs without critical gate failures |
...
| usable_continuation_response_rate | 1.0000 | Share of continuation iterations with usable update behavior |
| continuation_update_judge_score | 2.0000 | Judge-based quality of updating the diagnostic frame |
| continuation_input_judge_score | 2.0000 | Judge-based quality of reconstructing the new observation from context |
| continuation_update_strict_pass_rate | 1.0000 | Share of continuation iterations where CU1, CU2, CU3 all scored 2 |
...
| final_answer_strict_pass_rate | 0.0000 | 0.0000 | 0.0000 | frac(FA1=2 ∧ FA2=2 ∧ FA3=2 ∧ FA4=2 ∧ FA5=2) |
...
| final_alternative_context_handling | 0 | 1 | 1 |
| final_result_interpretation_usefulness | 0 | 0 | 2 |
| final_hypothesis_source_alignment | 0 | 1 | 1 |
...
| continuation_hypothesis_update_discipline | 0 | 0 | 1 |
| continuation_problem_understanding_update | 0 | 0 | 1 |
| continuation_next_check_progression | 0 | 0 | 1 |
| continuation_observation_resolution_context_recovery | 0 | 0 | 1 |
...
| continuation_next_check_progression | 0 | 0.0000 |
...
| bad_continuation_due_to_update_logic_rate | 0.0000 | frac(!usable_continuation ∧ CU4>0 ∧ (CU1=0 ∨ CU2=0 ∨ CU3=0)) |
| bad_continuation_despite_good_input_rate | 0.0000 | frac(!usable_continuation ∧ CU4=2) |
...
| continuation | usable cont 100%, update score 2.00, input score 2.00, no-hard-fail 100% | strong | continuation preserved diagnostic quality after the new observation |
...
Continuation behavior was stable:

- usable continuation rate: 100%
- continuation update strict pass rate: 100%
- continuation input strict pass rate: 100%

Quality maintained or improved between initial and continuation iterations.
...
|---|---|---:|---:|
| `d541773c-a7e2-42e0-bd59-44ddbfb8b29f` | `671dc57b-a589-4d1c-962a-2ba8564c97fc` | 1.8000 | true |
| `d541773c-a7e2-42e0-bd59-44ddbfb8b29f` | `b5bdb5ea-1e56-42d3-829a-8482e562825d` | 1.8000 | true |
...
|---|---:|---:|---:|---:|
| continuation_hypothesis_update_discipline | 1689 | 785 | 2474 | 0.000241 |
| continuation_next_check_progression | 1172 | 370 | 1542 | 0.000133 |
| continuation_observation_resolution_context_recovery | 1059 | 461 | 1520 | 0.000145 |
| continuation_problem_understanding_update | 1389 | 346 | 1735 | 0.000139 |
| evidence_pack_role_fit | 2884 | 1067 | 3951 | 0.000358 |
| evidence_pack_sufficiency | 4104 | 923 | 5027 | 0.000390 |
| final_alternative_context_handling | 9736 | 887 | 10623 | 0.000664 |
| final_first_check_discriminates | 9858 | 849 | 10707 | 0.000663 |
| final_hypothesis_source_alignment | 8338 | 1333 | 9671 | 0.000684 |
| final_no_root_cause_claim | 9766 | 590 | 10356 | 0.000606 |
| final_result_interpretation_usefulness | 1775 | 1257 | 3032 | 0.000340 |
| query_structuring_field_boundary_correctness | 713 | 537 | 1250 | 0.000143 |
| query_structuring_grounding_conservatism | 683 | 587 | 1270 | 0.000152 |
...
| judge_total | 53166 | 9992 | 63158 | 0.004657 |
| run_total | 61682 | 14523 | 76205 | 0.005453 |

Run total cost usd = runtime total cost usd + judge total cost usd = 0.000796 + 0.004657 = 0.005453
...
| evidence_pack_judge_score | 1.5000 | n/a | 1.5000 | mean of avg(EP1, EP2) over initial iter-s |
| final_answer_judge_score | 1.8000 | 1.8000 | 1.8000 | mean of avg(FA1, FA2, FA3, FA4, FA5) |
| query_structuring_no_hard_fail_rate | 0 | n/a | 0.0000 | frac(QS1>0 ∧ QS2>0) |
| evidence_pack_no_hard_fail_rate | 1 | n/a | 1.0000 | frac(EP1>0 ∧ EP2>0) |
...
| query_structuring_strict_pass_rate | 0 | n/a | 0.0000 | frac(QS1=2 ∧ QS2=2) |
| evidence_pack_strict_pass_rate | 0 | n/a | 0.0000 | frac(EP1=2 ∧ EP2=2) |
| final_answer_strict_pass_rate | 0 | 0 | 0.0000 | frac(FA1=2 ∧ FA2=2 ∧ FA3=2 ∧ FA4=2 ∧ FA5=2) |
| continuation_hypothesis_update_discipline_score | n/a | 2 | 2.0000 | mean(CU1) over continuation iter-s |
| continuation_problem_understanding_update_score | n/a | 2 | 2.0000 | mean(CU2) over continuation iter-s |
| continuation_next_check_progression_score | n/a | 2 | 2.0000 | mean(CU3) over continuation iter-s |
| continuation_observation_resolution_context_recovery_score | n/a | 2 | 2.0000 | mean(CU4) over continuation iter-s |
| usable_continuation_response_rate | n/a | 1 | 1.0000 | frac(CU1≥1 ∧ CU2≥1 ∧ CU3≥1 ∧ FA1≥1 ∧ FA2≥1 ∧ FA5≥1) |
| continuation_update_judge_score | n/a | 2.0000 | 2.0000 | mean of avg(CU1, CU2, CU3) over continuation iter-s |
| continuation_update_no_hard_fail_rate | n/a | 1 | 1.0000 | frac(CU1>0 ∧ CU2>0 ∧ CU3>0) |
| continuation_update_strict_pass_rate | n/a | 1 | 1.0000 | frac(CU1=2 ∧ CU2=2 ∧ CU3=2) |
| continuation_input_judge_score | n/a | 2 | 2.0000 | mean(CU4) over continuation iter-s |
| continuation_input_no_hard_fail_rate | n/a | 1 | 1.0000 | frac(CU4>0) |
| continuation_input_strict_pass_rate | n/a | 1 | 1.0000 | frac(CU4=2) |
