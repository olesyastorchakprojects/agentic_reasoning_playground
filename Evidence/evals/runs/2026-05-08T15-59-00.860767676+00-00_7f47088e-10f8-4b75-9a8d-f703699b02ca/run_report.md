...
- eval_run_id: `7f47088e-10f8-4b75-9a8d-f703699b02ca`
- run_type: `golden_dataset`
- status: `completed`
- started_at: `2026-05-08 15:59:00.860767676 UTC`
- completed_at: `2026-05-08 16:00:15.110004943 UTC`
- runtime_run_count: `1`
...
| final_answer_judge_score | 2.0000 | Judge-based quality of final diagnostic response |
...
| final_answer_judge_score | 2.0000 | mean over runs of avg(FA1, FA2, FA3, FA4, FA5) |
...
| final_answer_strict_pass_rate | 1.0000 | frac(FA1=2 ∧ FA2=2 ∧ FA3=2 ∧ FA4=2 ∧ FA5=2) |
...
|---|---:|---:|---:|
| final_no_root_cause_claim | 0 | 0 | 1 |
| final_first_check_discriminates | 0 | 0 | 1 |
| final_alternative_context_handling | 0 | 0 | 1 |
...
| query_structuring_grounding_conservatism | 1 | 0 | 0 |
| evidence_pack_role_fit | 0 | 1 | 0 |
| evidence_pack_sufficiency | 0 | 0 | 1 |
...
| query_structuring_field_boundary_correctness | 1 | 1.0000 |
...
|---|---|---|---|
| query structuring | judge 0.00, no-hard-fail 0%, runtime core 0% | weak | no strict pass on any run; 1 field boundary gate fail(s); runtime core success 0% |
| retrieval | strict recall 0%, nDCG 0.00 | weak | recall strong but ranking quality below threshold (nDCG 0.00) |
| evidence packing | judge 1.50, no-hard-fail 100% | strong | selected evidence pack was sufficient and mostly role-appropriate |
| final answer | usable 100%, judge 2.00, no-hard-fail 100% | strong | 100% usable, uncertainty preserved, source labels mostly correct |

### Failure Path

All 1 responses were usable. No hard failures at the final answer stage.

Soft weaknesses observed:

- **Query structuring**: strict pass rate 0%, no-hard-fail 0%, runtime core 0%

Main observed weakness: **query structuring** (composite 0.00). evidence packing, final answer were strong.
...
|---|---:|---:|---:|---:|
| evidence_pack_role_fit | 2884 | 1019 | 3903 | 0.000348 |
| evidence_pack_sufficiency | 4104 | 1020 | 5124 | 0.000409 |
| final_alternative_context_handling | 4887 | 349 | 5236 | 0.000314 |
| final_first_check_discriminates | 4948 | 361 | 5309 | 0.000320 |
| final_hypothesis_source_alignment | 4194 | 464 | 4658 | 0.000302 |
| final_no_root_cause_claim | 4902 | 268 | 5170 | 0.000299 |
| final_result_interpretation_usefulness | 889 | 658 | 1547 | 0.000176 |
| query_structuring_field_boundary_correctness | 713 | 393 | 1106 | 0.000114 |
| query_structuring_grounding_conservatism | 683 | 663 | 1346 | 0.000167 |

### Totals

| scope | prompt_tokens | completion_tokens | total_tokens | total_cost_usd |
|---|---:|---:|---:|---:|
| runtime | 4907 | 2754 | 7661 | 0.000796 |
| judge_total | 28204 | 5195 | 33399 | 0.002449 |
| run_total | 33111 | 7949 | 41060 | 0.003245 |

Run total cost usd = runtime total cost usd + judge total cost usd = 0.000796 + 0.002449 = 0.003245
