...
- eval_run_id: `d4c939c2-c7eb-412a-83cf-3117c2435554`
- run_type: `golden_dataset`
- status: `completed`
- started_at: `2026-05-08 16:47:05.038150420 UTC`
- completed_at: `2026-05-08 16:49:17.588026033 UTC`
- runtime_run_count: `1`
...
| final_answer_judge_score | 1.6000 | Judge-based quality of final diagnostic response |
...
| query_structuring_judge_score | 0.2500 | mean over runs of avg(QS1, QS2) |
| evidence_pack_judge_score | 0.7500 | mean over runs of avg(EP1, EP2) |
| final_answer_judge_score | 1.6000 | mean over runs of avg(FA1, FA2, FA3, FA4, FA5) |
| query_structuring_no_hard_fail_rate | 0.5000 | frac(QS1>0 ∧ QS2>0) |
...
| final_hypothesis_source_alignment | 1 | 1 | 0 |
...
| final answer | usable 100%, judge 1.60, no-hard-fail 100% | strong | 100% usable, uncertainty preserved, source labels mostly correct |
...
|---|---:|---:|---:|---:|
| continuation_hypothesis_update_discipline | 1689 | 951 | 2640 | 0.000275 |
| continuation_next_check_progression | 1172 | 387 | 1559 | 0.000136 |
| continuation_observation_resolution_context_recovery | 1059 | 408 | 1467 | 0.000135 |
| continuation_problem_understanding_update | 1389 | 344 | 1733 | 0.000138 |
| evidence_pack_role_fit | 2884 | 792 | 3676 | 0.000303 |
| evidence_pack_sufficiency | 4104 | 963 | 5067 | 0.000398 |
| final_alternative_context_handling | 9736 | 845 | 10581 | 0.000656 |
| final_first_check_discriminates | 9858 | 705 | 10563 | 0.000634 |
| final_hypothesis_source_alignment | 8338 | 1490 | 9828 | 0.000715 |
| final_no_root_cause_claim | 9766 | 618 | 10384 | 0.000612 |
| final_result_interpretation_usefulness | 1775 | 1233 | 3008 | 0.000335 |
| query_structuring_field_boundary_correctness | 713 | 325 | 1038 | 0.000101 |
| query_structuring_grounding_conservatism | 683 | 681 | 1364 | 0.000170 |
...
| judge_total | 53166 | 9742 | 62908 | 0.004607 |
| run_total | 61682 | 14273 | 75955 | 0.005403 |

Run total cost usd = runtime total cost usd + judge total cost usd = 0.000796 + 0.004607 = 0.005403
