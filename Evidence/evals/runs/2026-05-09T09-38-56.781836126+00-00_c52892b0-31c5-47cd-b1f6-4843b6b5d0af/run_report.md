...
- eval_run_id: `c52892b0-31c5-47cd-b1f6-4843b6b5d0af`
- run_type: `golden_dataset`
- status: `completed`
- started_at: `2026-05-09 09:38:56.781836126 UTC`
- completed_at: `2026-05-09 09:40:34.690316727 UTC`
- runtime_run_count: `1`
...
| gate_pass_rate | 1.0000 | Share of runs without critical gate failures |
| query_structuring_judge_score | 0.7500 | Judge-based semantic quality of query structuring |
...
| final_answer_judge_score | 1.9000 | Judge-based quality of final diagnostic response |
...
| query_structuring_judge_score | 1.5000 | n/a | 1.5000 | mean of avg(QS1, QS2) over initial iter-s |
| evidence_pack_judge_score | 1.5000 | n/a | 1.5000 | mean of avg(EP1, EP2) over initial iter-s |
| final_answer_judge_score | 2.0000 | 1.8000 | 1.9000 | mean of avg(FA1, FA2, FA3, FA4, FA5) |
| query_structuring_no_hard_fail_rate | 1.0000 | n/a | 1.0000 | frac(QS1>0 ∧ QS2>0) |
...
| query_structuring_field_boundary_correctness | 1 | 0 | 1 |
...
|---|---|---|---|
| query structuring | judge 0.75, no-hard-fail 100%, runtime core 0% | weak | no strict pass on any run; runtime core success 0% |
...
| final answer | usable 100%, judge 1.90, no-hard-fail 100% | strong | 1 partial source alignment (FA3<2) |
...
- **Query structuring**: strict pass rate 0%, no-hard-fail 100%, runtime core 0%
...
|---|---:|---:|---:|---:|
| continuation_hypothesis_update_discipline | 1689 | 576 | 2265 | 0.000200 |
| continuation_next_check_progression | 1172 | 357 | 1529 | 0.000130 |
| continuation_observation_resolution_context_recovery | 1059 | 531 | 1590 | 0.000159 |
| continuation_problem_understanding_update | 1389 | 476 | 1865 | 0.000165 |
| evidence_pack_role_fit | 2884 | 927 | 3811 | 0.000330 |
| evidence_pack_sufficiency | 4104 | 924 | 5028 | 0.000390 |
| final_alternative_context_handling | 9736 | 625 | 10361 | 0.000612 |
| final_first_check_discriminates | 9858 | 759 | 10617 | 0.000645 |
| final_hypothesis_source_alignment | 8338 | 1503 | 9841 | 0.000718 |
| final_no_root_cause_claim | 9766 | 627 | 10393 | 0.000614 |
| final_result_interpretation_usefulness | 1775 | 1343 | 3118 | 0.000357 |
| query_structuring_field_boundary_correctness | 713 | 480 | 1193 | 0.000132 |
| query_structuring_grounding_conservatism | 683 | 848 | 1531 | 0.000204 |
...
| judge_total | 53166 | 9976 | 63142 | 0.004653 |
| run_total | 61682 | 14507 | 76189 | 0.005450 |

Run total cost usd = runtime total cost usd + judge total cost usd = 0.000796 + 0.004653 = 0.005450
...
| evidence_pack_judge_score | 1.5000 | n/a | 1.5000 | mean of avg(EP1, EP2) over initial iter-s |
| final_answer_judge_score | 2.0000 | 1.8000 | 1.9000 | mean of avg(FA1, FA2, FA3, FA4, FA5) |
| query_structuring_no_hard_fail_rate | 1 | n/a | 1.0000 | frac(QS1>0 ∧ QS2>0) |
...
| final_answer_strict_pass_rate | 1 | 0 | 0.5000 | frac(FA1=2 ∧ FA2=2 ∧ FA3=2 ∧ FA4=2 ∧ FA5=2) |
