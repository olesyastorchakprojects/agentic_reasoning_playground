...
- eval_run_id: `8340dd54-c0ad-4b4c-a333-76fade947233`
- run_type: `golden_dataset`
- status: `completed`
- started_at: `2026-05-20 17:15:49.392945768 UTC`
- completed_at: `2026-05-20 17:29:02.551770481 UTC`
- runtime_run_count: `5`
...
| query_structuring_judge_score | 1.1000 | Judge-based semantic quality of query structuring |
...
| evidence_pack_judge_score | 1.9000 | Judge-based quality of selected evidence pack |
...
| continuation_update_judge_score | 1.7333 | Judge-based quality of updating the diagnostic frame |
| continuation_input_judge_score | 1.9000 | Judge-based quality of reconstructing the new observation from context |
| continuation_update_strict_pass_rate | 0.5000 | Share of continuation iterations where CU1, CU2, CU3 all scored 2 |
...
| query_structuring_judge_score | 1.1000 | n/a | 1.1000 | mean of avg(QS1, QS2) over initial iter-s |
| evidence_pack_judge_score | 1.9000 | n/a | 1.9000 | mean of avg(EP1, EP2) over initial iter-s |
| final_answer_judge_score | 1.9200 | 1.7400 | 1.8000 | mean of avg(FA1, FA2, FA3, FA4, FA5) |
...
| final_answer_no_hard_fail_rate | 1.0000 | 0.8000 | 0.8667 | frac(FA1>0 ∧ FA2>0 ∧ FA4>0 ∧ FA5>0) |
| diagnostic_move_hard_fail_rate | 0.0000 | 0.2000 | 0.1333 | 1 − final_answer_no_hard_fail_rate |
| query_structuring_strict_pass_rate | 0.2000 | n/a | 0.2000 | frac(QS1=2 ∧ QS2=2) |
| evidence_pack_strict_pass_rate | 0.8000 | n/a | 0.8000 | frac(EP1=2 ∧ EP2=2) |
| final_answer_strict_pass_rate | 0.6000 | 0.2000 | 0.3333 | frac(FA1=2 ∧ FA2=2 ∧ FA3=2 ∧ FA4=2 ∧ FA5=2) |
| continuation_hypothesis_update_discipline_score | n/a | 1.8000 | 1.8000 | mean(CU1) over continuation iter-s |
...
| continuation_update_judge_score | n/a | 1.7333 | 1.7333 | mean of avg(CU1, CU2, CU3) over continuation iter-s |
| continuation_update_no_hard_fail_rate | n/a | 0.7000 | 0.7000 | frac(CU1>0 ∧ CU2>0 ∧ CU3>0) |
| continuation_update_strict_pass_rate | n/a | 0.5000 | 0.5000 | frac(CU1=2 ∧ CU2=2 ∧ CU3=2) |
...
| final_alternative_context_handling | 0 | 2 | 13 |
| final_result_interpretation_usefulness | 0 | 0 | 15 |
| final_hypothesis_source_alignment | 2 | 5 | 8 |
| query_structuring_field_boundary_correctness | 0 | 3 | 2 |
| query_structuring_grounding_conservatism | 2 | 2 | 1 |
| evidence_pack_role_fit | 0 | 1 | 4 |
| evidence_pack_sufficiency | 0 | 0 | 5 |
| continuation_hypothesis_update_discipline | 0 | 2 | 8 |
...
|---|---|---|---|
| query structuring | judge 1.10, no-hard-fail 60%, soft precision 85%, grounded strict 55% | mixed | grounded strict recall 55%; strict contract pass 60% |
| retrieval | strict recall 93%, nDCG 0.78 | strong | recall was present, but ranking quality remained weak (nDCG 0.78) |
| evidence packing | judge 1.90, no-hard-fail 100% | strong | selected evidence pack was sufficient and mostly role-appropriate |
| final answer | usable 100%, judge 1.80, no-hard-fail 87% | strong | 2 premature certainty (FA1=0); 7 partial source alignment (FA3<2) |
| continuation | usable cont 60%, update score 1.73, input score 1.90, no-hard-fail 70% | mixed | partial degradation: usable rate 60%, no-hard-fail 70% |
...
|---|---|---:|---:|
| `8bc933a8-dfff-4c72-97a8-591a02527834` | `f0010137-bf23-498f-8f71-07ae21b5a4b1` | 1.4000 | true |
...
| `fa4f888a-92e1-40c8-8b28-f7d020c5f39b` | `893f869b-eea0-40f5-be53-a26f1d2704c1` | 1.6000 | false |
| `20d71364-f74c-46f9-a7a6-da260d3cd847` | `1a9fc53f-e1da-4a8a-b357-f16932b115c3` | 1.8000 | true |
...
|---|---:|---:|---:|---:|
| continuation_hypothesis_update_discipline | 17701 | 7753 | 25454 | 0.002436 |
| continuation_next_check_progression | 12294 | 6121 | 18415 | 0.001839 |
| continuation_observation_resolution_context_recovery | 11026 | 4194 | 15220 | 0.001390 |
| continuation_problem_understanding_update | 14812 | 4608 | 19420 | 0.001662 |
| evidence_pack_role_fit | 15742 | 3696 | 19438 | 0.001526 |
| evidence_pack_sufficiency | 22204 | 2519 | 24723 | 0.001614 |
| final_alternative_context_handling | 76185 | 6641 | 82826 | 0.005137 |
| final_first_check_discriminates | 77295 | 5464 | 82759 | 0.004958 |
| final_hypothesis_source_alignment | 65421 | 8431 | 73852 | 0.004957 |
| final_no_root_cause_claim | 76875 | 4669 | 81544 | 0.004778 |
| final_result_interpretation_usefulness | 14640 | 5314 | 19954 | 0.001795 |
| query_structuring_field_boundary_correctness | 4138 | 2823 | 6961 | 0.000772 |
| query_structuring_grounding_conservatism | 4508 | 4243 | 8751 | 0.001074 |
| judge_total | 412841 | 66476 | 479317 | 0.033937 |

| model | prompt_tokens_cost | completion_tokens_cost | total_cost_usd |
|---|---|---|---:|
| openai/gpt-oss-120b | 412841 * $0.05/1M = 0.020642 | 66476 * $0.2/1M = 0.013295 | 0.033937 |
...
| observation_extraction | openai/gpt-oss-120b | 4202 | 5442 | 9644 | 0.003896 |
...
| judge_total | 412841 | 66476 | 479317 | 0.033937 |
| run_total | 488281 | 100790 | 589071 | 0.065842 |

Run total cost usd = runtime total cost usd + judge total cost usd = 0.031904 + 0.033937 = 0.065842
...
| query_structuring_judge_score | 2.0000 | n/a | n/a | 2.0000 | mean of avg(QS1, QS2) over initial iter-s |
...
| query_structuring_strict_pass_rate | 1 | n/a | n/a | 1.0000 | frac(QS1=2 ∧ QS2=2) |
...
| final_answer_judge_score | 2.0000 | 1.8000 | 1.4000 | 1.7333 | mean of avg(FA1, FA2, FA3, FA4, FA5) |
| query_structuring_no_hard_fail_rate | 1 | n/a | n/a | 1.0000 | frac(QS1>0 ∧ QS2>0) |
| evidence_pack_no_hard_fail_rate | 1 | n/a | n/a | 1.0000 | frac(EP1>0 ∧ EP2>0) |
| final_answer_no_hard_fail_rate | 1 | 1 | 1 | 1.0000 | frac(FA1>0 ∧ FA2>0 ∧ FA4>0 ∧ FA5>0) |
| diagnostic_move_hard_fail_rate | 0 | 0 | 0 | 0.0000 | 1 − final_answer_no_hard_fail_rate |
...
| query_structuring_judge_score | 0.5000 | n/a | n/a | 0.5000 | mean of avg(QS1, QS2) over initial iter-s |
| evidence_pack_judge_score | 2.0000 | n/a | n/a | 2.0000 | mean of avg(EP1, EP2) over initial iter-s |
| final_answer_judge_score | 1.8000 | 1.6000 | 2.0000 | 1.8000 | mean of avg(FA1, FA2, FA3, FA4, FA5) |
| query_structuring_no_hard_fail_rate | 0 | n/a | n/a | 0.0000 | frac(QS1>0 ∧ QS2>0) |
| evidence_pack_no_hard_fail_rate | 1 | n/a | n/a | 1.0000 | frac(EP1>0 ∧ EP2>0) |
