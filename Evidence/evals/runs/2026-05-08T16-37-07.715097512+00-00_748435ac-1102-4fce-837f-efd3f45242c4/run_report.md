...
- eval_run_id: `748435ac-1102-4fce-837f-efd3f45242c4`
- run_type: `golden_dataset`
- status: `completed`
- started_at: `2026-05-08 16:37:07.715097512 UTC`
- completed_at: `2026-05-08 16:39:17.914507717 UTC`
- runtime_run_count: `1`
...
| final_answer_judge_score | 1.7000 | Judge-based quality of final diagnostic response |
...
| final_answer_judge_score | 1.7000 | mean over runs of avg(FA1, FA2, FA3, FA4, FA5) |
...
|---|---:|---:|---:|
| final_no_root_cause_claim | 0 | 1 | 1 |
...
| final_hypothesis_source_alignment | 0 | 2 | 0 |
...
| final answer | usable 100%, judge 1.70, no-hard-fail 100% | strong | 100% usable, uncertainty preserved, source labels mostly correct |
...
|---|---|---:|---:|
| `d541773c-a7e2-42e0-bd59-44ddbfb8b29f` | `b5bdb5ea-1e56-42d3-829a-8482e562825d` | 1.6000 | true |
...
|---|---:|---:|---:|---:|
| continuation_hypothesis_update_discipline | 1689 | 546 | 2235 | 0.000194 |
| continuation_next_check_progression | 1172 | 357 | 1529 | 0.000130 |
| continuation_observation_resolution_context_recovery | 1059 | 390 | 1449 | 0.000131 |
| continuation_problem_understanding_update | 1389 | 418 | 1807 | 0.000153 |
| evidence_pack_role_fit | 2884 | 979 | 3863 | 0.000340 |
| evidence_pack_sufficiency | 4104 | 1094 | 5198 | 0.000424 |
| final_alternative_context_handling | 9736 | 645 | 10381 | 0.000616 |
| final_first_check_discriminates | 9858 | 1233 | 11091 | 0.000740 |
| final_hypothesis_source_alignment | 8338 | 1291 | 9629 | 0.000675 |
| final_no_root_cause_claim | 9766 | 739 | 10505 | 0.000636 |
| final_result_interpretation_usefulness | 1775 | 1386 | 3161 | 0.000366 |
| query_structuring_field_boundary_correctness | 713 | 504 | 1217 | 0.000136 |
| query_structuring_grounding_conservatism | 683 | 774 | 1457 | 0.000189 |
...
| judge_total | 53166 | 10356 | 63522 | 0.004730 |
| run_total | 61682 | 14887 | 76569 | 0.005526 |

Run total cost usd = runtime total cost usd + judge total cost usd = 0.000796 + 0.004730 = 0.005526
