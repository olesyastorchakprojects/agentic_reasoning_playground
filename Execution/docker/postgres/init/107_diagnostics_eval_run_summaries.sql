...
create table if not exists diagnostics.eval_run_summaries (
    ...
    query_structuring_no_hard_fail_rate numeric(10,6) not null,
    evidence_pack_no_hard_fail_rate numeric(10,6) not null,
    final_answer_no_hard_fail_rate numeric(10,6) not null,
    diagnostic_move_hard_fail_rate numeric(10,6) not null,
    runtime_qs_core_success_rate numeric(10,6) not null default 0,
    runtime_qs_macro_precision_soft numeric(10,6) not null default 0,
    runtime_qs_macro_recall_strict numeric(10,6) not null default 0,
    runtime_qs_macro_recall_soft numeric(10,6) not null default 0,
    runtime_qs_grounded_strict_recall numeric(10,6) not null default 0,
    runtime_retrieval_mean_ndcg numeric(10,6) not null default 0,
    runtime_retrieval_all_strict_recall_success_rate numeric(10,6) not null default 0,
    runtime_retrieval_all_soft_recall_success_rate numeric(10,6) not null default 0,
    runtime_retrieval_zero_hit_rate numeric(10,6) not null default 0,
    runtime_retrieval_candidate_cards_recall_strict numeric(10,6) not null default 0,
    runtime_retrieval_incident_primary_recall_strict numeric(10,6) not null default 0,
    runtime_retrieval_incident_alternatives_recall_strict numeric(10,6) not null default 0,
    runtime_retrieval_theory_evidence_recall_strict numeric(10,6) not null default 0,
